 ...
 */
public class EntitySplitMergeHeuristicStep extends GeneralMHStep {
    public EntitySplitMergeHeuristicStep(World world){
        super(world);
    }

    @Override
    public MHProposal createProposal() {
        return new EntitySplitMergeHeuristicProposal(world);
    }
    ...
    private final static Logger logger = LoggerFactory.getLogger(EntitySplitMergeHeuristicStep.class);
    
    public class EntitySplitMergeHeuristicProposal extends MHProposal {
        ...
        public EntitySplitMergeHeuristicProposal(World world) {
